...
public class MascotaJpaController implements Serializable {
    ...
    public MascotaJpaController(){
        ...
        emf = Persistence.createEntityManagerFactory("Ferrari_Pablo_tpo2PU"); //Con esto logro que mi jpaMascota haga un llamado a mi unidad de persistencia
                                                                              // y me la va a identificar como una clase de entidad logica y la conectara a la base de datos
    }
