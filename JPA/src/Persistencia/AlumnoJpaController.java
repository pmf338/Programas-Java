...
public class AlumnoJpaController implements Serializable {
    ...
    //creo una entityManagerFactory a partir de una clase que haya creado
    public AlumnoJpaController () {
        emf = Persistence.createEntityManagerFactory("JDBC_PU"); //coloco el nombre de mi unidad de persistenca que se ubica en persistence.xml
    }
